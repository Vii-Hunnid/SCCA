      ...
      {activeConversationId ? (
        <div className="flex h-full overflow-hidden">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            <div 
              ...
              style={{ borderColor: 'var(--border-color)', backgroundColor: 'color-mix(in srgb, var(--bg-secondary) 30%, transparent)' }}
            >
              ...
              <div className="flex items-center gap-1 ml-2">
                ...
                {showDeleteConfirm ? (
                  <div 
                    ...
                    style={{ backgroundColor: 'color-mix(in srgb, var(--neon-red) 5%, transparent)', border: '1px solid color-mix(in srgb, var(--neon-red) 20%, transparent)' }}
                  >
                    <AlertTriangle className="w-3 h-3" style={{ color: 'var(--neon-red)' }} />
                    <span className="text-[10px]" style={{ color: 'var(--neon-red)' }}>Delete chat?</span>
                    <button
        ...
        <div className="flex items-center justify-center h-full">
          <div className="text-center max-w-md">
            <Shield className="w-12 h-12 mx-auto mb-4" style={{ color: 'var(--neon-cyan)', opacity: 0.2 }} />
            <h2 className="text-lg font-display mb-2 text-[var(--text-primary)]">
